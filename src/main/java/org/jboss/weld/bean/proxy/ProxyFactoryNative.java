 ...
 * @author Ales Justin
 */
public class ProxyFactoryNative<T> implements PrivilegedAction<T> {
     ...
     */
    public ProxyFactoryNative(String contextId, Class<?> proxiedBeanType, Set<? extends Type> typeClosure, Bean<?> bean) {
     ...
     */
    public ProxyFactoryNative(String contextId, Class<?> proxiedBeanType, Set<? extends Type> typeClosure, String proxyName,
                              Bean<?> bean) {
    ...
    private static ProxyNameHolder createCompoundProxyName(String contextId, Bean<?> bean, TypeInfo typeInfo,
        ...
        return ProxyFactoryOverridden.createCompoundProxyName(contextId, bean, typeInfo, name);
    }
     ...
     */
    static class ProxyNameHolder {
        private String packageName;
        private String className;

        ProxyNameHolder(String packageName, String className, Bean<?> bean) {
